<template>
  <div v-if="product" class="product-detail">
    ...
    <!-- 상세 정보 -->
    <div class="detail-item"><strong>공시 제출월:</strong> {{ product.fin_prdt_cd }}</div>
    ...
    <div class="detail-item"><strong>기준이율:</strong> {{ product.intr_rate }}%</div>
...
async function onSubscribe() {
  try {
    await userStore.subscribe(route.params.id)
